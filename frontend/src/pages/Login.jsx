      ...
      >
        <div className="card-raised p-8 sm:p-10 relative overflow-hidden">
          ...
          <div className="text-center mb-8 relative">
            ...
            <p className="text-gray-600 dark:text-gray-300">Sign in to continue learning</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 relative">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full btn-elevated py-3.5 font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
            >
